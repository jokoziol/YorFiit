...
class WorkoutCalories {
    ...
    public class func getCaloriesString(workoutType: String?, timeInSeconds: Int, distanceInMeters: Double) -> String? {
    ...
    public class func getCalories(workoutType: String?, timeInSeconds: Int, distanceInMeters: Double) -> Double {
    ...
    private class func getWorkoutTypeMetValue(_ workoutType: String?) -> Double {
